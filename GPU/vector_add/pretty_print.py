...
LN = [4000,40000,100000,200000,300000,400000,600000]
...
n_mapping = {4000 : 0,40000 : 1,100000 : 2,200000 : 3,300000 : 4,400000 : 5,600000 : 6}
...
plt.title("Addition vectorielle avec différents paramètres (échelle semi-log)")
plt.show()
